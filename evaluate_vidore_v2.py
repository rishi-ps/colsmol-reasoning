"""
Memory-efficient ViDoRe v2 evaluation for ColSmol models.
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Evaluate ColSmol on ViDoRe v2 with memory-efficient scoring")
    ...
    parser.add_argument("--output-folder", default="results_v2", help="Output folder for results")
    parser.add_argument("--benchmark", default="ViDoRe(v2)", help="Benchmark name (ViDoRe(v1) or ViDoRe(v2))")
